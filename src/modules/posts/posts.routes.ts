...
import { publishPostSchema,schedulePostSchema } from './posts.schema';
...
postRoutes.post('/schedule',authenticate,
  validate(schedulePostSchema),controller.schedule,);
postRoutes.get('/',authenticate, controller.listPosts);
